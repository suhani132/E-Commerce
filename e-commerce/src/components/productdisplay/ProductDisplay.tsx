      ...
      <div className="ProductDisplay-right flex flex-col h-full w-1/4 md:w-1/2 ">
        ...
        <div className="size my-8 text-gray-900">
            ...
            <div className="right-size flex gap-9 ">
                <div className="border-2 py-1 px-2 cursor-pointer border-gray-300 bg-slate-50">S</div>
                <div className="border-2 py-1 px-2 cursor-pointer border-gray-300 bg-slate-50">M</div>
                <div className="border-2 py-1 px-2 cursor-pointer border-gray-300 bg-slate-50">L</div>
                <div className="border-2 py-1 px-2 cursor-pointer border-gray-300 bg-slate-50">XL</div>
                <div className="border-2 py-1 px-2 cursor-pointer border-gray-300 bg-slate-50">XXL</div>                
            </div>
        </div>
        <button onClick={()=>{addToCart(Product.id)}} className="min-w-fit py-2 px-1 bg-red-800 text-white">ADD TO CART</button>
        <p className="category mt-8"><span className="font-semibold">Category:</span>Women, T-Shirt, Crop-Top</p>
        <p className="tags mt-2"><span className="font-semibold">Tags:</span>Mordern, Latest</p>
